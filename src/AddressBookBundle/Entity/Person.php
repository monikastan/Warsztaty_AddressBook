...
class Person
{
    ...
    private $description;
    /**
     * @ORM\OneToMany(targetEntity="Address", mappedBy="person", cascade={"persist"}, cascade={"remove"})
     */
    private $addresses;
    /**
     * @ORM\OneToMany(targetEntity="Phone", mappedBy="person", cascade={"persist"}, cascade={"remove"})
     */
    private $phones;
    /**
